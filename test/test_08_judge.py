...
assert_test(results, "create_sector", lambda: client.create_sector("", "test_sector_auto"))
assert_test(results, "create_sector_folder", lambda: client.create_sector_folder("", "test_folder_auto"))
